...
```bash
git clone https://github.com/Shineouhearth/guizang-social-card-skill-137.git
cd guizang-social-card-skill-137
npm install
npm start
```
...
> 这个 Skill 是 [guizang-ppt-skill](https://github.com/Shineouhearth/guizang-social-card-skill-137) 的姊妹项目,共享美学语言但独立维护。PPT 解决"横向翻页演讲",这里解决"静态信息流图文"。
...
**❌ 不合适**:横向翻页 PPT(用 [guizang-ppt-skill](https://github.com/Shineouhearth/guizang-social-card-skill-137))/ 长视频生成 / 纯图片修图 / 无版式诉求的纯文字编辑
...
<!-- Last updated: 2026-06-06 16:21:38 -->
